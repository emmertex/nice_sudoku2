...
private val techniquePriority = mapOf(
    ...
    "BUG" to 18, "Bivalue Universal Grave" to 18, "BIVALUE_UNIVERSAL_GRAVE" to 18,
    ...
    "X_CYCLES" to 24, "X-Cycles" to 24, "X-Cycle" to 24, "X_CYCLE" to 24,
    "XY_CHAIN" to 25, "XY-Chain" to 25,
    "XY_CHAINS_TypeONE" to 25,
    "HIDDEN_XY_TYPEONE" to 25,
    "WXYZ_WING" to 26, "WXYZ Wing" to 26, "WXYZ-Wing" to 26, "VWXYZ_WING" to 26,
    "UVWXYZ_WING" to 27,
    ...
    "FORCING_CHAINS" to 38, "Forcing Chains" to 38, "FORCING_NETS" to 38,
